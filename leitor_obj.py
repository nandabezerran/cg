...
obj = open('./objetos/obj/armario_puxadores.obj', 'r')
conteudo = obj.readlines()    
arquivo = open('arquivo.txt', 'w')
final = open('./objetos/armario_puxadores.h','w') 
...
final.write('const int armario_puxadores_num_vertices = ' + str(len(v)) + ';\n')
final.write('const int armario_puxadores_num_faces = ' + str(len(f)) + ';\n\n')
final.write('float armario_puxadores_vertices[] = { \n')
vertices.append("\n")
...
final .write('int armario_puxadores_faces[] = { \n')
final.write(matrix) 
final.write('\n\n};\n\n')


final.write('float armario_puxadores_normais[] = { \n')
normais.append("\n")

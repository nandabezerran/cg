...
Cubo::Cubo(double cAresta, Ponto* cCentro): aresta(cAresta), centro(cCentro), Objeto("Cubo", PINK, false){
    ...
    faces.push_back(CriarFace(vertices[0], vertices[3], vertices[1], "F1"));
    faces.push_back(CriarFace(vertices[3], vertices[2], vertices[1], "F2"));
    faces.push_back(CriarFace(vertices[6], vertices[5], vertices[3], "F3"));
    faces.push_back(CriarFace(vertices[5], vertices[2], vertices[3], "F4"));
    faces.push_back(CriarFace(vertices[7], vertices[6], vertices[0], "F5"));
    faces.push_back(CriarFace(vertices[6], vertices[3], vertices[0], "F6"));
    faces.push_back(CriarFace(vertices[7], vertices[0], vertices[4], "F7"));
    faces.push_back(CriarFace(vertices[0], vertices[1], vertices[4], "F8"));
    faces.push_back(CriarFace(vertices[6], vertices[7], vertices[4], "F9"));
    faces.push_back(CriarFace(vertices[5], vertices[6], vertices[4], "F10"));
    faces.push_back(CriarFace(vertices[4], vertices[2], vertices[5], "F11"));
    faces.push_back(CriarFace(vertices[4], vertices[1], vertices[2], "F12"));
    ...
    for (auto face: faces) {
        ...
        face->p = new Plano(face->p1->p, biblioteca::EncontrarNormal(p1p2, p1p3, 3));
    }
